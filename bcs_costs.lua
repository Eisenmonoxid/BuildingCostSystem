...
function SetMyBuildingCosts()
	LoadBuildingCostSystem() -- Do not comment this out, this loads the BCS. / Nicht auskommentieren, das hier lädt das BCS.
	...
	--The arguments here are factors, that means: 1.5 -> 1.5 times the original cost
	--Die Argumente hier sind Faktoren, das heißt: 1.5 -> 1.5 mal den Originalbetrag
...
--[[
	-> These are just example calls to show how to reset the costs!
	-> Das hier sind nur Beispielaufrufe um zu zeigen, wie man die Kosten wieder zurücksetzt!
]]--
...
--[[
	...
	-> In dieser Funktion muss nichts verändert werden!
]]--
